...
export const TextInput = forwardRef<HTMLInputElement, TextInputProps>(function TextInput(
  ...
  return (
    <input
      ...
      className={cn(
        'min-h-11 w-full rounded-control border bg-background-subtle px-4 py-2 text-body-sm text-text shadow-inner transition-colors duration-fast ease-standard',
